...
export default function OutsideClass() {
    return (
        <div className="border-b border-neutral-900 pb-4 mx-6 lg:mx-32 flex flex-wrap items-center justify-center lg:justify-evenly">
            ...
            <motion.img initial={{x: 50, opacity: 0}} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{duration: 1, delay: 0.5}}
                src="/images/dunkingPic.jpg" alt="picture of me" 
